...
public class AdministrationController {
     ...
     */
    public Role[] getRoles(String sessionId, int role) throws Exception {
        try {
     ...
     */
    public Role[] getRoles(String sessionId, String userName, String userSource) throws Exception {
        try {
     ...
     */
    public void createRole(String sessionId, int role, String userName, String userSource) throws Exception, AccessDeniedException, ConfigException, DMSException {
        try {
     ...
     */
    public void deleteRole(String sessionId, int role, String userName, String userSource) throws Exception, AccessDeniedException, ConfigException, DMSException {
        try {
     ...
     */
    public AuthenticationSource getAuthenticationSource(String sessionId, String name) throws Exception, AccessDeniedException, ConfigException, DMSException {
        try {
     ...
     */
    public String getAuthenticationSourceParams(String sessionId, String name, String className) throws Exception {
        try {
     ...
     */
    public void createAuthenticationSource(String sessionId, String authenticationSourceName, String className, String xmlParameters) throws Exception {
        try {
     ...
     */
    public void updateAuthenticationSource(String sessionId,
            String authenticationSourceName, String newAuthenticationSourceName, String className,
            String xmlParameters) throws Exception {
        try {
            client.updateAuthenticationSource(sessionId, authenticationSourceName, newAuthenticationSourceName, className, xmlParameters);
        } catch (Exception e) {
            throw new ExceptionHelper().convertException(e);
        }
    }
     ...
     */
    public void deleteAuthenticationSource(String sessionId, String name) throws Exception {
        try {
     ...
     */
    public String getAvailableAuthenticationSource(String sessionId) throws Exception {
        try {
     ...
     */
    public String getAvailableAuthenticationSourceParams(String sessionId, String className) throws Exception {
        try {
     ...
     */
    public void createUser(String sessionId, String uid, String userName, String mail, String password, String authenticationSourceName) throws Exception {
        try {
     ...
     */
    public void updateUser(String sessionId, String uid, String userName, String mail, String password, String authenticationSourceName) throws Exception {
        try {
     ...
     */
    public void deleteUser(String sessionId, String uid, String authenticationSourceName) throws Exception{
        try {
     ...
     */
    public void createGroup(String sessionId, String gid, String name, String authenticationSourceName) throws Exception {
        try {
     ...
     */
    public void updateGroup(String sessionId, String gid, String name, String authenticationSourceName) throws Exception {
        try {
     ...
     */
    public void deleteGroup(String sessionId, String gid, String authenticationSourceName) throws Exception {
        try {
     ...
     */
    public void addUserToGroup(String sessionId, String uid, String gid, String authenticationSourceName) throws Exception, AccessDeniedException, ConfigException, DMSException {
        try {
     ...
     */
    public void removeUserFromGroup(String sessionId, String uid, String gid, String authenticationSourceName) throws Exception, AccessDeniedException, ConfigException, DMSException {
        try {
     ...
     */
    public User getUser(String sessionId, String uid, String authenticationSourceName) throws Exception, AccessDeniedException, ConfigException, DMSException {
        try {
     ...
     */
    public User[] getUsers(String sessionId, String gid, String authenticationSourceName) throws Exception {
        try {
     ...
     */
    public Group getGroup(String sessionId, String gid, String authenticationSourceName) throws Exception, AccessDeniedException, ConfigException, DMSException {
        try {
     ...
     */
    public Group[] getGroups(String sessionId, String userId, String authenticationSourceName) throws Exception, AccessDeniedException, ConfigException, DMSException {
        try {
     ...
     */
    public void reIndex(String sessionId, String path) throws Exception, AccessDeniedException, ConfigException, DMSException {
        try {
     ...
     */
    public int getReIndexProgress(String sessionId) throws Exception {
        try {
     ...
     */
    public Document[] getCheckedOutDocuments(String sessionId) throws Exception {
        try {
     ...
     */
    public void clearLock(String sessionId, long documentId) throws Exception {
        try {
     ...
     */
    public void changeOwnerShip(String sessionId, long dmEntityId, int dmEntityType, String userName, String userSource) throws Exception {
        try {
     ...
     */
    public User[] getConnectedUsers(String sessionId) throws Exception {
        try {
     ...
     */
    public Session[] getAllEnabledSessions(String sessionId) throws Exception {
        try {
     ...
     */
    public Session[] getEnabledSessions(String sessionId, String userName, String userSource) throws Exception {
        try {
     ...
     */
    public void removeEnabledSession(String sessionId, String sessionIdToRemove) throws Exception {
        try {
     ...
     */
    public void removeEnabledSessions(String sessionId, String userName, String userSource) throws Exception {
        try {
