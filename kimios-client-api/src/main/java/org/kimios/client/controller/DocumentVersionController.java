...
public class DocumentVersionController {
     ...
     */
    public long createDocumentVersion(String sessionId, long documentId) throws Exception, DMSException,
     ...
     */
    public long createDocumentVersionFromLatest(String sessionId, long documentId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public void updateDocumentVersion(String sessionId, long documentId, long documentTypeId, String xmlStream) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public DocumentVersion getLastDocumenVersion(String sessionId, long documentId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public DocumentVersion getDocumentVersion(String sessionId, long versionId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public DocumentVersion[] getDocumentVersions(String sessionId, long documentId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public DocumentComment getDocumentComment(String sessionId, long documentId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public DocumentComment[] getDocumentComments(String sessionId, long documentVersionId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public void createDocumentComment(String sessionId, long documentVersionId, String comment) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public void updateDocumentComment(String sessionId, long commentId, long documentVersionId, String comment) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     * Remove comment
     */
    public void deleteDocumentComment(String sessionId, long commentId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public String getMetaStringValue(String sessionId, long documentVersionId, long metaId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     * Return the meta value for a given document version and a given meta data
     */
    public double getMetaNumberValue(String sessionId, long documentVersionId, long metaId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     * Return the meta value for a given document version and a given meta data
     */
    public boolean getMetaBooleanValue(String sessionId, long documentVersionId, long metaId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     * Return the meta value for a given document version and a given meta data
     */
    public Date getMetaDateValue(String sessionId, long documentVersionId, long metaId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public void updateMetas(String sessionId, long documentVersionId, String xmlStream) throws Exception, DMSException, ConfigException, AccessDeniedException,
            XMLException
    {
        try {
     ...
     */
    public Meta getMeta(String sessionId, long metaId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public Meta[] getMetas(String sessionId, long documentTypeId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     */
    public Meta[] getUnheritedMetas(String sessionId, long documentTypeId) throws Exception, DMSException, ConfigException, AccessDeniedException {
        try {
     ...
     * @since 1.0
     */
    public List<MetaValue> getMetaValues(String sessionId, long documentVersionId) throws Exception, DMServiceException {
