...
public class SecurityController {
     ...
     * Start a session
     */
    public String startSession(String userName, String password, String source) throws Exception, DMSException {
        try {
     ...
     */
    public boolean isSessionAlive(String sessionId) throws Exception, DMSException {
        try {
     ...
     */
    public User getUser(String sessionId) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public User[] getUsers(String sessionId, String source) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public Group[] getGroups(String sessionId, String source) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public Group getGroup(String sessionId, String groupId, String source) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public boolean canRead(String sessionId, long dmEntityId, int dmEntityType) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public boolean canWrite(String sessionId, long dmEntityId, int dmEntityType) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public boolean hasFullAccess(String sessionId, long dmEntityId, int dmEntityType) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public AuthenticationSource[] getAuthenticationSources() throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public boolean canCreateWorkspace(String sessionId) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public boolean hasStudioAccess(String sessionId) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public boolean hasReportingAccess(String sessionId) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public boolean isAdmin(String sessionId) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public DMEntitySecurity[] getDMEntitySecurities(String sessionId, long dmEntityId, int dmEntityType) throws Exception, AccessDeniedException, DMSException {
        try {
     ...
     */
    public void updateDMEntitySecurities(String sessionId, long dmEntityId, int dmEntityType, boolean isRecursive, Vector<DMEntitySecurity> des) throws Exception, AccessDeniedException, DMSException {
        try {
