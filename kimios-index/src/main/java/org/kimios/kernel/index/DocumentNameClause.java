...
public class DocumentNameClause implements SearchClause
{
    private String documentNameQuery;

    public DocumentNameClause(String documentNameQuery)
    {
    ...
    {
        try {
            return IndexHelper.getWildCardQuery("DocumentName", "*" + this.documentNameQuery.toLowerCase() + "*");
        } catch (Exception ex) {
