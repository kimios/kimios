...
public class DocumentTypeClause implements SearchClause
{
    private long documentTypeUid;

    public DocumentTypeClause(long documentTypeUid)
    {
    ...
    {
        try {
            return IndexHelper.getLongRangeQuery("DocumentTypeUid", this.documentTypeUid, this.documentTypeUid);
        } catch (Exception ex) {
