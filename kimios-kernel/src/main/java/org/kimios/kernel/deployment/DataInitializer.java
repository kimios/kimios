...
{
    private DataInitializerCtrl dataInitializerCtrl;

    public DataInitializerCtrl getDataInitializerCtrl()
    {
        return dataInitializerCtrl;
    }

    public void setDataInitializerCtrl(DataInitializerCtrl dataInitializerCtrl)
    {
