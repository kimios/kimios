...
public interface MetaFeedFactory
{
    ...
    public void updateMetaFeed(MetaFeedImpl metaFeed) throws ConfigException, DataSourceException;

    public void deleteMetaFeed(MetaFeedImpl metaFeed) throws ConfigException, DataSourceException;
}
