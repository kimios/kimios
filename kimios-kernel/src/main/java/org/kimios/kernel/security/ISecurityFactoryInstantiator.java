 ...
 */
public interface ISecurityFactoryInstantiator {
    CredentialsGenerator getCredentialsGenerator() throws ConfigException;

    DMEntitySecurityFactory getDMEntitySecurityFactory();
