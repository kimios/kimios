...
import org.kimios.telemetry.factory.NotificationFactory;
...
public class TelemetryController extends AKimiosController implements ITelemetryController {
    ...
    public TelemetryController(ISearchController searchController,
        ...
        documentTypeName = ConfigurationManager.getValue("dms.telemetry.type.name") != null ?
                ConfigurationManager.getValue("dms.telemetry.type.name") : documentTypeName;
        metaDateName = ConfigurationManager.getValue("dms.telemetry.type.metaname") != null ?
                ConfigurationManager.getValue("dms.telemetry.type.metaname") : metaDateName;

        templateUrl = ConfigurationManager.getValue("dms.telemetry.reminder.templateurl") != null ?
                ConfigurationManager.getValue("dms.telemetry.reminder.templateurl") : templateUrl;
        ...
        metaReminderDateName = ConfigurationManager.getValue("dms.telemetry.type.metaremindername") != null ?
                ConfigurationManager.getValue("dms.telemetry.type.metaremindername") : metaReminderDateName;
        
        try {
            remainingDaysBeforeNotification = ConfigurationManager.getValue("dms.telemetry.reminderdelay") != null ?
                    Integer.parseInt(ConfigurationManager.getValue("dms.telemetry.reminderdelay")) : remainingDaysBeforeNotification;
        } catch (Exception ex){
