 ...
 */
public class TelemetryMailRunnable extends MailTaskRunnable {


    private static Logger logger = LoggerFactory.getLogger(TelemetryMailRunnable.class);

    private Email email;
    private NotificationFactory notificationFactory;
    private long notificationId;

    public TelemetryMailRunnable(Email email, NotificationFactory factory, long notificationId) {
        super(email);
