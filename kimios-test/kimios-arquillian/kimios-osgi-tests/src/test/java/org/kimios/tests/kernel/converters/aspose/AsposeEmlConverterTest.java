...
import org.kimios.converter.impl.vendors.aspose.MailToHTML;
...
public class AsposeEmlConverterTest extends KernelTestAbstract {
    ...
    public static JavaArchive createDeployment() {
        ...
        JavaArchive archive =
                OsgiDeployment.createArchive( AsposeEmlConverterTest.class.getSimpleName() + ".jar", AsposeEmlConverterTest.class,
                StringTools.class,
        ...
        File exportedFile = new File(AsposeEmlConverterTest.class.getSimpleName() + ".jar");
    ...
    public void testDocumentSimple() throws IOException {
        docUid = new DocumentCreator(this.documentController)
                .createDocument(adminSession, folderTest1,
                        ...
                        "tests/converters/eml_sample.eml",
                        "eml_sample", "eml");
        assertTrue(docUid != -1);
        ...
        InputSource source = converterController.convertDocument(this.adminSession, docUid, MailToHTML.class.getName(), "html");
