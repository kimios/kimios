...
public class AsposeOdpConverterTest extends KernelTestAbstract {


    private static Logger logger = LoggerFactory.getLogger(AsposeOdpConverterTest.class);
    ...
    public static JavaArchive createDeployment() {
        ...
        JavaArchive archive =
                OsgiDeployment.createArchive( AsposeOdpConverterTest.class.getSimpleName() + ".jar", AsposeOdpConverterTest.class,
                StringTools.class,
        ...
        File exportedFile = new File(AsposeOdpConverterTest.class.getSimpleName() + ".jar");
    ...
    public void testDocumentSimple() throws IOException {
        docUid = new DocumentCreator(this.documentController)
                .createDocument(adminSession, folderTest1,
                        ...
                        "tests/converters/odp_sample.odp",
                        "odp_sample", "odp");
        assertTrue(docUid != -1);
