...
import org.kimios.converter.impl.vendors.aspose.DocxToHTML;
import org.kimios.converter.impl.vendors.aspose.PptToHTML;
...
public class AsposePptxConverterTest extends KernelTestAbstract {


    private static Logger logger = LoggerFactory.getLogger(AsposePptxConverterTest.class);
    ...
    public static JavaArchive createDeployment() {
        ...
        JavaArchive archive =
                OsgiDeployment.createArchive( AsposePptxConverterTest.class.getSimpleName() + ".jar",
                        AsposePptxConverterTest.class,
                        StringTools.class,
        ...
        archive.addAsResource("tests/converters/doc_sample.docx");
        ...
        File exportedFile = new File(AsposePptxConverterTest.class.getSimpleName() + ".jar");
    ...
    public void testDocumentSimple() throws IOException {
        docUid = new DocumentCreator(this.documentController)
                .createDocument(adminSession, this.folderTest1,
                        this.getClass().getClassLoader(),
                        "tests/converters/pptx_sample.pptx",
                        "pptx_sample", "pptx");
        assertTrue(docUid != -1);
        ...
        InputSource source = converterController.convertDocument(this.adminSession, docUid, PptToHTML.class.getName(), "html");
