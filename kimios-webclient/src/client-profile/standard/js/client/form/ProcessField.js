 ...
 */
kimios.form.ProcessField = Ext.extend(Ext.form.ComboBox,{
    constructor : function(config){
        this.fieldLabel = kimios.lang('StartWorkflow');
        this.editable = false;
    ...
    initComponent : function(){
        kimios.form.ProcessField.superclass.initComponent.apply(this, arguments);
