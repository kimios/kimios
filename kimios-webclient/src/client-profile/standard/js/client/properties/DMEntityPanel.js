...
kimios.properties.DMEntityPanel = Ext.extend(kimios.FormPanel, {
  ...
  getDMEntityType : function(type){
    switch (type){
      case 1: return kimios.lang('Workspace');
      case 2: return kimios.lang('Folder');
      case 3: return kimios.lang('Document');
      default: return null;
    }
  },
  ...
  getDMEntityIconCls : function(type){
    switch (type) {
      case 1: return 'dm-entity-tab-properties-workspace';
      case 2: return 'dm-entity-tab-properties-folder';
      case 3: return 'dm-entity-tab-properties-document';
      default: return null;
    }
  }
