 ...
 */
public class DocumentDeletedWithActiveShareException extends DoneWithWarningException {

    private String message = "Document deleted with active shares ongoing";

    private long dmEntityId;
    private String dmEntityPath;

    public DocumentDeletedWithActiveShareException() {
        super();
    }

    public DocumentDeletedWithActiveShareException(long uid, String path) {
        super();
        this.dmEntityId = uid;
        this.dmEntityPath = path;
    }
